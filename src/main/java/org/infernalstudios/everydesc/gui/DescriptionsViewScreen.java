...
public class DescriptionsViewScreen extends Screen {
    public static final int PAGE_INDICATOR_TEXT_Y_OFFSET = 16;
    public static final int PAGE_TEXT_X_OFFSET = 36;
    public static final int PAGE_TEXT_Y_OFFSET = 30;
    public static final DescriptionsViewScreen.BookAccess EMPTY_ACCESS = new DescriptionsViewScreen.BookAccess() {
        /**
    ...
    private DescriptionsViewScreen.BookAccess bookAccess;
    ...
    public interface BookAccess {
        ...
        static DescriptionsViewScreen.BookAccess fromItem(ItemStack pStack) {
            if (pStack.is(Items.WRITTEN_BOOK)) {
                return new DescriptionsViewScreen.WrittenBookAccess(pStack);
            } else {
                return (DescriptionsViewScreen.BookAccess)(pStack.is(Items.WRITABLE_BOOK) ? new DescriptionsViewScreen.WritableBookAccess(pStack) : DescriptionsViewScreen.EMPTY_ACCESS);
            }
        }
    }

    @OnlyIn(Dist.CLIENT)
    public static class WritableBookAccess implements DescriptionsViewScreen.BookAccess {
        ...
        private static List<String> readPages(ItemStack pWrittenBookStack) {
            ...
            return (List<String>)(compoundtag != null ? DescriptionsViewScreen.loadPages(compoundtag) : ImmutableList.of());
        }
    ...
    @OnlyIn(Dist.CLIENT)
    public static class WrittenBookAccess implements DescriptionsViewScreen.BookAccess {
        private final List<String> pages;
